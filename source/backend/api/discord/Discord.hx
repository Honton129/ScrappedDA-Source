...
class DiscordClient
{
	...
	private static final _defaultID:String = "980676489420881950";
	...
	public static function changePresence(?details:String = 'In The Title Screen', ?state:String = "Gettin' Corrupted On a Friday Night", ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{

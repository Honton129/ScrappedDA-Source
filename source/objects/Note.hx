		...
		if(noteData > -1 && noteType != value) {
			switch(value) {
				case 'Hurt Note':
					...
					reloadNote('noteSkins/NOTE_assets-hurt');
				...
				case 'Demon Note':
					ignoreNote = mustPress;
					reloadNote('noteSkins/NOTE_assets-demon');
					noteSplashData.texture = 'noteSplashes/noteSplashes-electric';
					missHealth = isSustainNote ? 10 : 10;
					hitCausesMiss = true;
					lowPriority = true;

				case 'Bullet Note': //go pico yeah yeah
					reloadNote('noteSkins/NOTE_assets-bullet');
					noMissAnimation = true;
					noAnimation = true;
					missHealth = isSustainNote ? 0.25 : 0.2;

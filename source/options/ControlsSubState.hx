...
class ControlsSubState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		#if DISCORD_ALLOWED
		DiscordClient.changePresence('In the Controls Settings Category', 'Adjusting The Keybinds');
		#end
		...
		bgFront = new FlxSprite().loadGraphic(Paths.image('optionsFront'));
		...
		var textSpr:AttachedSprite = new AttachedSprite();
		textSpr.makeGraphic(100, 35, FlxColor.WHITE);
		textSpr.sprTracker = text;
		textSpr.copyAlpha = false;
		textSpr.alpha = 0.25;
		add(textSpr);
		add(text);

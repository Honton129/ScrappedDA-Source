...
/**
 * SHADER TOOK FROM: "https://www.shadertoy.com/view/ldjGzV"
 * ADAPTED TO HAXE BY HONTON129!
 */

class VCRShader extends FlxBasic
{
    public var shader(default, null):VCRWithNoGlitch = new VCRWithNoGlitch();
...
class VCRWithNoGlitch extends FlxShader
{
    @:glFragmentSource('
    #pragma header

...
class CharacterEditorState extends MusicBeatState
{
	...
	var clickIcon:Bool = false; //new shit
	...
	function addHelpScreen()
	{
		...
		\nClick on Health Icon - Changes The Icon Animation
	...
	override function update(elapsed:Float)
	{
		...
		if(FlxG.mouse.overlaps(healthIcon) && FlxG.mouse.justPressed || (clickIcon && FlxG.keys.justPressed.ESCAPE))
		{
			clickIcon = !clickIcon;

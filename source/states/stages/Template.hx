...
//import states.stages.objects.*; //UNCOMMENT THIS IF YOU WANNA USE STAGES OBJECTS
	...
	override function eventPushed(event:objects.Note.EventNote)
	{
		...
		switch(event.event)
		{
			case "My Event":
				...
				//Paths.music('myMusic') //preloads music/myMusic.ogg
		}
	}
			...
			case "My Event":
				switch(event.value1)
				{
					...
					default:
						...
						//Paths.music('myMusicThree') //preloads music/myMusicThree.ogg
				}
		}
	}
}